...
export function AnaSayfaSmokeSayaci(props: AnaSayfaSmokeSayaciProps) {
  ...
  return (
    <>
      ...
      <button aria-label="Geçmiş" className="text-[#c3c6d7] hover:bg-[#222a3d] transition-colors active:scale-95 duration-200 p-2 rounded-full flex items-center justify-center">
      <span className="material-symbols-outlined text-xl">history</span>
      </button>
      <button aria-label="Ayarlar" className="text-[#c3c6d7] hover:bg-[#222a3d] transition-colors active:scale-95 duration-200 p-2 rounded-full flex items-center justify-center">
      ...
      <button onClick={onIncrement} className="col-span-2 flex items-center justify-center gap-3 bg-gradient-to-b from-primary-container to-primary text-on-primary py-5 px-6 rounded-2xl font-bold text-lg active:scale-95 transition-transform duration-200 shadow-lg shadow-primary-container/20 border-none cursor-pointer">
      <span className="material-symbols-outlined" style={{fontVariationSettings: "'FILL' 1"}}>add</span>
                          Arttır
                      </button>
      {/*  Azalt Button (Secondary Container)  */}
      <button onClick={onDecrement} className="flex items-center justify-center gap-2 bg-secondary-container text-on-secondary-container py-4 px-4 rounded-xl font-medium active:scale-95 transition-transform duration-200 border-none cursor-pointer">
      <span className="material-symbols-outlined">remove</span>
                          Azalt
                      </button>
      {/*  Sıfırla Button (Error state)  */}
      <button onClick={onReset} className="flex items-center justify-center gap-2 bg-surface-container-highest text-error py-4 px-4 rounded-xl font-medium active:scale-95 transition-transform duration-200 border-none cursor-pointer">
      ...
      {/*  Sayaç (Active)  */}
      <button className="flex flex-col items-center justify-center text-[#b4c5ff] bg-[#2563eb]/20 rounded-xl px-4 py-1 active:scale-90 transition-transform hover:text-[#f8fafc] border-none cursor-pointer">
      ...
      {/*  İstatistik (Inactive)  */}
      <button className="flex flex-col items-center justify-center text-[#c3c6d7] px-4 py-1 active:scale-90 transition-transform hover:text-[#f8fafc] border-none cursor-pointer">
